...
@section('content')
  ...
  <div class="container-main">
    ...
    <article class="card p-6 lg:p-8 animate-pop">
      <form action="{{ route('commissions.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <div class="animate-fade-up">
            ...
            <input id="name" name="name" type="text" value="{{ old('name') }}" required
                   class="w-full rounded-lg border-zinc-300 focus:border-rose-500 focus:ring-rose-500 dark:bg-zinc-900 dark:border-zinc-700 transition-shadow" />
          </div>
        ...
        <div class="grid gap-4 sm:grid-cols-2">
          <div class="animate-fade-up">
            ...
            <select id="style" name="style"
                    class="w-full rounded-lg border-zinc-300 focus:border-rose-500 focus:ring-rose-500 dark:bg-zinc-900 dark:border-zinc-700 transition-shadow">
              <option {{ old('style') === 'Black' ? 'selected' : '' }}>Black</option>
        ...
        <div class="animate-fade-up">
          ...
          <textarea id="description" name="description" rows="6" required
                    placeholder="Tell me about the concept, mood, motifs, must-haves…"
                    class="w-full rounded-lg border-zinc-300 focus:border-rose-500 focus:ring-rose-500 dark:bg-zinc-900 dark:border-zinc-700 transition-shadow">{{ old('description') }}</textarea>
        </div>
